"""
# ----------------------------------------------------------------------------------
# Note: This script uses WNEP2 potential and old version of Wizard for calculations.
# The new version of Wizard no longer supports these calculations. 
# Please revert to the old version if reproduction is needed.
# ----------------------------------------------------------------------------------
"""
