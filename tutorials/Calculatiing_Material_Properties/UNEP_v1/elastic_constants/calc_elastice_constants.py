...
for alloy_info in alloy_infos:
    ...
    nep_data[alloy_info.formula]['C13'] = Cij[0][2]
    nep_data[alloy_info.formula]['C33'] = Cij[2][2]
    nep_data[alloy_info.formula]['C44'] = Cij[3][3]
    nep_data[alloy_info.formula]['C66'] = Cij[5][5]
